...
SNAPSHOT_DIR = 'D:/AIchanger/myowncheckpoint/'
WEIGHT_DECAY = 0.0005
...
def main():
    ...
    for step in range(args.num_steps):
        ...
        if step % args.save_pred_every == 0:
            loss_value, images, labels, preds, _ = sess.run([reduced_loss, image_batch, label_batch, pred,train_op], feed_dict=feed_dict)
