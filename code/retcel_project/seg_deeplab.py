...
try:
    from retcel_project.deeplab_resnet import DeepLabResNetModel,prepare_label
except:
...
SNAPSHOT_DIR = '/data/b/wangguangyuan/rectal_segment/DCE/tfrecord/myown_checkpoint/deeplab/'
DEVICE='/gpu:0'
...
def main():
    ...
    with tf.device(DEVICE):
        ...
        # frozen, and to not update the values provided b
        # y the pre-trained model.
        ...
        # optimiser = tf.train.RMSPropOptimizer(args.learning_rate, RMSPROP_DECAY,
        ...
        for step in range(args.num_steps):
            ...
            duration = time.time() - start_time
            print('step {:d} \t loss = {:.3f}, iou = {:.3f}, ({:.3f} sec/step)'.format(step, loss_value, iou_loss, duration))
