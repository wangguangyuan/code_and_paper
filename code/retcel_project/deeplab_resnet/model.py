...
try:
    from retcel_project.deeplab_resnet .network import Network
except:
    from .network import Network

import tensorflow as tf

class UnetArtrous(Network):
    def setup(self, is_training, num_classes):
        (self.feed('data')
         ...
         # .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn_conv3')
         .max_pool(2, 2, 2, 2, name='pool3')
         .atrous_conv(3, 3, 512, 1, padding='SAME', biased=True, relu=True, name='atrous_conv_1')
         .atrous_conv(3, 3, 512, 2, padding='SAME', biased=True, relu=True, name='atrous_conv_2')
         .atrous_conv(3, 3, 512, 4, padding='SAME', biased=True, relu=True, name='atrous_conv_3')
         .atrous_conv(3, 3, 512, 8, padding='SAME', biased=True, relu=True, name='atrous_conv_4')
         .atrous_conv(3, 3, 512, 16, padding='SAME', biased=True, relu=True, name='atrous_conv_5')
         .atrous_conv(3, 3, 512, 32, padding='SAME', biased=True, relu=True, name='atrous_conv_6'))

        (self.feed('atrous_conv_1',
                   'atrous_conv_2',
                   'atrous_conv_3',
                   'atrous_conv_4',
                   'atrous_conv_5',
                   'atrous_conv_6')
            .add(name='add_1')
            .deconv(3, 3, 256, 2, 2, (128, 128),name='deconv3')
            .conv(3, 3, 256, 1, 1,  biased=True, relu=True, name='uconv3_0'))
            # .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn_deconv3_'))


        (self.feed('uconv3_0',
                   'conv3_2')
         .concat(axis=3, name='concat3')
         .conv(3, 3, 256, 1, 1, biased=True, relu=True, name='uconv3_1')
         .conv(3, 3, 256, 1, 1, biased=True, relu=True, name='uconv3_2')
         # .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn_deconv3')
         .deconv(3, 3, 128, 2, 2, (256, 256), name='deconv2'))

        (self.feed('deconv2',
                   'conv2_2')
         .concat(axis=3, name='concat2')
         .conv(3, 3, 128, 1, 1, biased=True, relu=True, name='uconv2_1')
         .conv(3, 3, 128, 1, 1, biased=True, relu=True, name='uconv2_2')
         # .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn_deconv2')
         .deconv(3, 3, 64, 2, 2, (512, 512), name='deconv1'))

        (self.feed('deconv1',
                   'conv1_2')
         .concat(axis=3, name='concat1')
         .conv(3, 3, 64, 1, 1, biased=True, relu=True, name='uconv1_1')
         .conv(3, 3, 64, 1, 1, biased=True, relu=True, name='uconv1_2')
         # .batch_normalization(is_training=is_training, activation_fn=tf.nn.relu, name='bn_deconv1')
         .conv(1, 1, num_classes, 1, 1, biased=True, relu=True, sigmoid=False, name='uconv1'))
